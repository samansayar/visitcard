<x-app-layout>
    <x-slot name="header">ویرایش سمت {{ $data->name_semat }}</x-slot>
    <div x-data="{ name_semat: '', handlerMessage: true }">
        {{-- TODO =>  CODEING HERE.... --}}
        <div class="lg:grid grid-cols-12 gap-4 w-full relative">
            <div class="lg:col-span-7 w-full relative rounded-md">

                <form method="post" action="{{ route('admin.semat.update', $data) }}"
