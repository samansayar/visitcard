<x-app-layout>
    <x-slot name="header">لیست دسترسی ها</x-slot>
                    ...
                    <tbody>
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td class="border-dashed border-t border-gray-200 text-center">
                                    <span
                                        class="text-gray-700 justify-center px-6 py-3 flex items-center text-sm">{{ $item->accessbiliy }}</span>
                                </td>
                                <td class="border-dashed border-t border-gray-200 text-center">
                                    <span
                                ...
                                <td
                                    ...
                                    {{-- Delete --}}
                                    <form method="POST" action="{{ route('admin.accessbility.destroy', $item) }}">
                                        @csrf
                                        @method('delete')
                                        <button title="حذف"
