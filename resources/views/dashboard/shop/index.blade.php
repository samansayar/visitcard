<x-app-layout>
    <x-slot name="header">لیست فروشگاه های من</x-slot>
    ...
    <div class="container mx-auto py-4" x-data="datatables()" x-cloak>
        ...
        <div class="mb-6">
            ...
            background="transparent" speed="1" class="w-32"></lottie-player> --}}
                        ...
                        <div class="mx-auto w-full flex mt-2 justify-center items-center">
            ...
            background="transparent" speed="1" class="w-32"></lottie-player> --}}
                        ...
                        <div class="mx-auto w-full mt-2 flex justify-center items-center">
                            <a href="{{ route('shop.index') }}"
                                class="text-white bg-red-400 mx-auto hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-xs w-full sm:w-auto px-4 py-2 text-center dark:bg-green-500 dark:hover:bg-green-600 transition duration-150 dark:focus:ring-green-700">
                                برو به لیست فروشگاه
                            </a>
                        </div>
                    </div>
                    ...
                    <tbody>
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td class="border-dashed border-t border-gray-200 text-center">
                                    <span
                                        class="text-gray-700 justify-center px-6 py-3 flex items-center text-sm">{{ $item->created_at->diffForHumans() }}</span>
                                </td>
                                <td class="border-dashed border-t border-gray-200 text-center">
                                    <span
                                        class="text-gray-700 justify-center px-6 py-3 flex items-center text-sm">{{ $item->name_shop }}</span>
                                </td>
                                <td class="border-dashed border-t border-gray-200 text-center">
                                    <span
                                        class="text-gray-700 justify-center px-6 py-3 flex items-center text-sm">{{ $item->type_shop }}</span>
                                </td>
                                <td class="border-dashed border-t border-gray-200 text-center">
                                    <span
                                        class="text-gray-700 justify-center px-6 py-3 flex items-center text-sm">{{ $item->founder_shop }}</span>
                                </td>
                                <td class="border-dashed border-t border-gray-200 text-center">
                                    <span
                                ...
                                <td class="border-dashed border-t border-gray-200 text-center">
                                    <div class="w-full flex justify-around items-center">
                                        {{-- Delete --}}
                                        <form method="POST" action="{{ route('shop.destroy', $item) }}">
                                            @csrf
                                            @method('delete')
                                            <button title="حذف"
                                        ...
                                        {{-- Verify / Reject --}}
                                        <form method="POST" action="{{ route('shop.update', $item) }}"
