<nav class=" bg-white w-full border-gray-400 border-t z-30 relative flex justify-between items-center mx-auto pl-8 pr-14 py-3">
    <!-- logo -->
    ...
    <div class="flex flex-col items-center space-x-3" x-data='{open : false}'>
        ...
        <div x-show="open" x-transition class="absolute h-auto left-0 bottom-0 top-[74px]">
            <div class="bg-white w-44 flex flex-col  rounded-lg shadow-md p-1">
                <a href="#" class="hover:bg-indigo-600 transition duration-200 rounded-md hover:text-indigo-100 text-gray-700 px-2 py-2 flex items-center">
                    <span>
